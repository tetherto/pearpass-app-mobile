...
- **Option A - Emulator**:
  ...
  3. Select a device (e.g., Pixel 9 Pro, Android 16)
...
cd pearpass-app-mobile/e2e-mobile-newdesign
```
...
ANDROID_AVD_NAME=Pixel_9_Pro_API_34        # Your AVD name from Android Studio
...
1. **For Android Emulator**:
   ...
   emulator -avd Pixel_9_Pro_API_34
