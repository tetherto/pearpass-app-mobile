...
/* ============================
        HEADER
============================ */
  sidebarScreen: '//android.view.ViewGroup[@resource-id="sidebar-screen"]',
  sidebarTitle: '//android.widget.TextView[@resource-id="sidebar-title"]',
/* ============================
        FOLDERS LIST
============================ */
...
============================ */
  ...
  addDevicePopupShareVaultTab: '~Share this Vault',
  addDevicePopupShareVaultTabText: '//android.widget.TextView[@text="Share this Vault"]',
  addDevicePopupImportVaultTab: '~Import vault',
  addDevicePopupImportVaultTabText: '//android.widget.TextView[@text="Import vault"]',
  ...
  addDevicePopupWarningText: '//android.widget.TextView[@text="Keep this code private. Anyone with it can connect a device to your vault."]',
  addDevicePopupWarningIcon: '(//android.widget.SeekBar[@content-desc="Bottom Sheet"])[2]/android.widget.ScrollView/android.view.ViewGroup/com.horcrux.svg.SvgView[2]/com.horcrux.svg.GroupView/com.horcrux.svg.PathView[1]',
  ...
  vaultKeyFieldInput: '//android.widget.EditText[@text="Insert vault key..."]',
...
============================ */
  ...
  createNewFolderPageSaveButton: '~Save',
  createNewFolderPageSaveButtonText: '//android.widget.TextView[@text="Save"]',
  createNewFolderPageSaveButtonIcon: '//android.view.ViewGroup[@content-desc="Save"]/com.horcrux.svg.SvgView/com.horcrux.svg.GroupView/com.horcrux.svg.PathView',
/* ============================
        TEST FOLDER
============================ */
...
/* ============================
            CHOOSE VAULT
============================ */
  chooseVaultButton: '//android.view.ViewGroup[@content-desc="Kazik"]',
  chooseVaultButtonText: '//android.widget.TextView[@text="Kazik"]',
  chooseVaultButtonIcon: '//android.view.ViewGroup[@content-desc="Kazik"]/com.horcrux.svg.SvgView[1]',
  chooseVaultDropdownIcon: '//android.view.ViewGroup[@content-desc="Kazik"]/com.horcrux.svg.SvgView[2]/com.horcrux.svg.GroupView/com.horcrux.svg.PathView',
  chooseVaultDropdownMenu: '//android.widget.FrameLayout[@resource-id="android:id/content"]/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.widget.ScrollView/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup[1]/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup[2]/android.view.ViewGroup[3]/android.widget.ScrollView',
  chooseVaultDropdownItem: '~Valeron',
