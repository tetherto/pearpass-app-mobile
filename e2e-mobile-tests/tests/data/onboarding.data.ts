...
export const ONBOARDING_STEPS: OnboardingStep[] = [
  ...
  },
  {
    ...
    subDescription:
      'No one can unlock your data, not even us. Your data stays fully encrypted and local to your device. Keep your master password safe — if you lose it, it\'s gone forever.',
  },
  {
    index: 3,
  ...
  },
  {
    ...
    subDescription:
      'Store everything — from passwords to payment cards, IDs and private notes — securely and privately.',
  },
  {
    index: 5,
