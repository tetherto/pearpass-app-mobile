...
exports.withNativeClipboardIOS = void 0;
const config_plugins_1 = require("@expo/config-plugins");
const fs = __importStar(require("fs"));
const path = __importStar(require("path"));
const withNativeClipboardIOS = (config) => {
    ...
    config = (0, config_plugins_1.withXcodeProject)(config, (cfg) => {
        ...
        if (projectGroup) {
            ...
            project.addSourceFile(`${projectName}/NativeClipboard.swift`, { target: project.getFirstTarget().uuid }, projectGroup);
            // Add Objective-C file
            project.addSourceFile(`${projectName}/NativeClipboard.m`, { target: project.getFirstTarget().uuid }, projectGroup);
        }
        return cfg;
    });
    return config;
};
exports.withNativeClipboardIOS = withNativeClipboardIOS;
