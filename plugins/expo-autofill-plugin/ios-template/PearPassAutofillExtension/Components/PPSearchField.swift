...
//
//  search field. Mirrors android-template/res/layout/include_pp_search_field.xml.
...
struct PPSearchField: View {
    ...
    var placeholder: String = NSLocalizedString("Search", comment: "search field default placeholder")
