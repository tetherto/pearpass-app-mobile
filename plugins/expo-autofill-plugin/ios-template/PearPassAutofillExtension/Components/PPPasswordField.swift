...
//
//  password field. Mirrors android-template/res/layout/include_pp_password_field.xml.
...
struct PPPasswordField: View {
    ...
    var body: some View {
        HStack(alignment: .center, spacing: PPSpacing.s4) {
            ...
            .buttonStyle(.plain)
            .accessibilityLabel(NSLocalizedString("Toggle password visibility", comment: "password field eye button"))
        }
