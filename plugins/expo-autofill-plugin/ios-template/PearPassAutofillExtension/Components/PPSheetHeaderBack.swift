...
//
//  sheet header (back variant). Mirrors android-template/res/layout/include_pp_sheet_header_back.xml.
        ...
        ZStack {
            ...
            HStack {
                if showBack, let onBack = onBack {
                    ...
                    .buttonStyle(.plain)
                    .accessibilityLabel(NSLocalizedString("Back", comment: "sheet header back button"))
                } else {
                ...
                if showClose, let onClose = onClose {
                    ...
                    .buttonStyle(.plain)
                    .accessibilityLabel(NSLocalizedString("Close", comment: "sheet header close button"))
                } else {
                    Color.clear.frame(width: 40, height: 40)
                }
            }
