  ...
  const onSubmit = async (formValues) => {
    ...
    try {
      ...
      try {
        ...
        logger.error('VaultDeleteScreen', 'deleteVaultLocal failed:', error)
      ...
      footer={
        <View style={styles.footer}>
          <Button
            ...
            disabled={isLoading}
            testID="vault-delete-discard-button"
          >
            {t`Discard`}
          </Button>
    ...
    >
      ...
      <View style={styles.fields}>
        ...
        <PasswordField
          ...
          testID="vault-delete-password-input"
        />
          ...
          <>
            <View style={styles.eraseRow}>
              <View style={styles.eraseLabel}>
                ...
                <Link
                  ...
                  testID="vault-delete-eraseall-link"
                >
              ...
              <ToggleSwitch
                ...
                testID="vault-delete-eraseall-toggle"
              />
            </View>
            ...
            {eraseFromAllDevices ? (
              <AlertMessage
                ...
                testID="vault-delete-eraseall-alert"
              />
            ) : null}
          </>
        ) : null}
        ...
        {submitError ? (
          <AlertMessage
            ...
            testID="vault-delete-error-alert"
          />
        ) : null}
      </View>
    </Layout>
