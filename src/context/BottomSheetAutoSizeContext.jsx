...
const BottomSheetAutoSizeContext = createContext()

export const BottomSheetAutoSizeProvider = ({ children }) => {
  ...
  return (
    <BottomSheetAutoSizeContext.Provider value={ctx}>
    ...
    </BottomSheetAutoSizeContext.Provider>
  )
}
