...
import { ModifyVaultModalContent } from './index'
...
describe('ModifyVaultModalContent', () => {
  ...
  it('renames an unprotected vault and closes the modal', async () => {
    ...
    fireEvent.changeText(
      getByTestId('modify-vault-modal-name-input'),
      'Renamed Vault'
    )
    fireEvent.press(getByTestId('modify-vault-modal-save-button'))
  ...
  it('updates the password for a protected vault', async () => {
    ...
    await waitFor(() =>
      expect(
        getByTestId('modify-vault-modal-current-password-input')
      ).toBeTruthy()
    )
    ...
    fireEvent.changeText(
      getByTestId('modify-vault-modal-new-password-input'),
      'Strong#2026'
    )
    fireEvent.changeText(
      getByTestId('modify-vault-modal-repeat-password-input'),
      'Strong#2026'
    )
    fireEvent.press(getByTestId('modify-vault-modal-save-button'))
  ...
  it('cancels without saving', () => {
    ...
    fireEvent.press(getByTestId('modify-vault-modal-cancel-button'))
