        ...
        >
          <View style={styles.formContainer}>
            ...
            <Text
              ...
              accessibilityLabel="create-password-description"
            ...
            <View style={styles.termsContainer}>
                <AppWarning
                  ...
                  accessibilityLabel="create-password-warning"
              ...
              <View style={styles.checkboxContainer}>
                ...
                <View style={styles.textContainer}>
                  <Text style={styles.bottomText}>
                    ...
                    <Text style={styles.linkText} onPress={handleTermsPress} testID="create-password-terms-link" accessibilityLabel="create-password-terms-link">
